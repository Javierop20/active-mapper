...
os.system("sudo apt-get install zeek")
os.system("mkdir /opt/zeek/share/zeek/site/ja3/")
...
os.system("echo @load tuning/json-logs.zeek>>/opt/zeek/share/zeek/site/local.conf")
os.system("echo @load tuning/track-all-assets>>/opt/zeek/share/zeek/site/local.conf")
os.system("echo @load ./ja3>>/opt/zeek/share/zeek/site/local.conf")
